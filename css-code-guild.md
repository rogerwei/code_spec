...
[9 编辑器配置](#user-content-9-编辑器配置)

[10 参考](#user-content-10-参考)
...
```css
body {
    background: url(//m.ouku.com/img/bg.png) no-repeat 0 0;
}
```
...
refer :https://github.com/litbfet/spec/blob/master/css-style-guide.md